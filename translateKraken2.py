...
# Normalize the file paths if provided
if args.infile:
    args.infile = os.path.normpath(args.infile)
if args.outfile:
    args.outfile = os.path.normpath(args.outfile)
if args.tddir:
    args.tddir = os.path.normpath(args.tddir)
...
tempfilename= "./"+args.outfile+"_TEMP_Taxids.txt"
...
if args.tddir:
    command="cat {} | singularity exec ./taxonkit.sif taxonkit lineage --data-dir {} | singularity exec ./taxonkit.sif taxonkit reformat --data-dir {}".format(tempfilename, args.tddir, args.tddir)
else:
    command="cat {} | singularity exec ./taxonkit.sif taxonkit lineage | singularity exec ./taxonkit.sif taxonkit reformat".format(tempfilename)
